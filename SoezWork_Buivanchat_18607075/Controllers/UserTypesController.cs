...
namespace SoezWork_Buivanchat_18607075.Controllers
{
    public class UserTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserTypeId,UserCode,UserTypeName")] UserType userType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserTypeId,UserCode,UserTypeName")] UserType userType)
        {
            if (ModelState.IsValid)
            {
